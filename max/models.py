...
# sentence-transformers removed: use OpenAI / LiteLLM embedding providers instead
...
# Local sentence-transformers support removed to avoid heavy local dependencies.
# Embeddings should be provided via LiteLLM/OpenAI or other lightweight providers.
...
def _get_litellm_embedding(
    ...
    **kwargs: Any,
    ...
    # No local sentence-transformers special case: prefer remote/lightweight embedders
    # use api key from kwargs or env
    api_key = kwargs.pop("api_key", None) or get_api_key(provider_name)
...
def _adjust_call_args(provider_name: str, model_name: str, kwargs: dict):
    ...
    if provider_name == "openrouter":
        # Use a generic referer/title for OpenRouter calls (unbranded)
