...
def convert_out(settings: Settings) -> SettingsOutput:
    ...
    chat_model_fields.append(
        {
            ...
            "description": "Select provider for main chat model used by the agent",
            "type": "select",
    ...
    chat_model_section: SettingsSection = {
        "id": "chat_model",
        "title": "Chat Model",
    "description": "Selection and settings for the main chat model",
    ...
    embed_model_section: SettingsSection = {
        ...
        "description": f"Settings for the embedding model used by the agent.<br><h4>⚠️ No need to change</h4>The default embedding model {default_settings['embed_model_name']} is configured to run via the selected provider. Change only if you have specific requirements for embeddings.",
    ...
    "description": "Settings for the web browser model. This integration uses <a href='https://github.com/browser-use/browser-use' target='_blank'>browser-use</a> to handle web interactions.",
    ...
    "description": "Settings for authentication to use the web UI.",
        "fields": auth_fields,
        "tab": "external",
    }
    ...
    api_keys_section: SettingsSection = {
        "id": "api_keys",
        "title": "API Keys",
    "description": "API keys for model providers and services used by the framework. You can set multiple API keys separated by a comma (,). They will be used in round-robin fashion.",
    ...
    memory_fields.append(
        ...
        "description": "The agent will automatically recall memories based on conversation context.",
            "type": "switch",
    ...
    "description": "This system can use external MCP servers, local or remote as tools.",
   ...
   # Secrets section
    ...
    mcp_server_fields.append(
        {
            ...
            "description": "Expose this service as an SSE/HTTP MCP server. This will make this instance available to MCP clients.",
            "type": "switch",
    ...
    mcp_server_section: SettingsSection = {
        "id": "mcp_server",
        "title": "A0 MCP Server",
    "description": "This service can be exposed as an SSE MCP server. See <a href=\"javascript:openModal('settings/mcp/server/example.html')\">connection example</a>.",
    ...
    a2a_fields.append(
        {
            ...
            "description": "Expose this instance as an A2A server. This allows other agents to connect via A2A protocol.",
            "type": "switch",
    ...
    a2a_section: SettingsSection = {
        "id": "a2a_server",
        "title": "A0 A2A Server",
    "description": "This instance can be exposed as an A2A server. See <a href=\"javascript:openModal('settings/a2a/a2a-connection.html')\">connection example</a>.",
        "fields": a2a_fields,
        "tab": "mcp",
    }
    ...
    external_api_fields.append(
        {
            ...
            "title": "API Examples",
            "description": "View examples for using the external API endpoints with API key authentication.",
            "type": "button",
    ...
    external_api_section: SettingsSection = {
        "id": "external_api",
        "title": "External API",
    "description": "Provides external API endpoints for integration with other applications. "
    ...
    "description": "Backup and restore data and configurations using glob pattern-based file selection.",
...
def get_default_settings() -> Settings:
    ...
    # Default to a universal OpenAI text embedding model to avoid heavy local deps
